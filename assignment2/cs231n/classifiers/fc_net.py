...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None):
    ...
    hidden_first, first_cache = affine_relu_forward(X, W1, b1)
    scores, second_cache = affine_forward(hidden_first, W2, b2)
    ############################################################################
    #                             END OF YOUR CODE                             #
    ############################################################################
...
class FullyConnectedNet(object):
  ...
  def loss(self, X, y=None):
    ...
    ############################################################################
    pass
    hidden_layers, caches, dp_caches = list(range(self.num_layers + 1)), list(range(self.num_layers)), list(range(self.num_layers - 1))
    hidden_layers[0] = X

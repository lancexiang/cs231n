...
class CaptioningRNN(object):
  ...
  def loss(self, features, captions):
    ...
    captions_in_emd, emb_in_cache = word_embedding_forward(captions_in, W_embed)

    if self.cell_type == 'rnn':
        h, rnn_cache = rnn_forward(captions_in_emd, h0, Wx, Wh, b)
    elif self.cell_type == 'lstm':
        h, lstm_cache = lstm_forward(captions_in_emd, h0, Wx, Wh, b)
